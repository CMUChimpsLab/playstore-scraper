...
.method private calculateImageMatrixFromScale(FLandroid/graphics/Matrix;)V
    ...
    .line 295
    iget-object v5, p0, Lcom/google/android/material/floatingactionbutton/FloatingActionButtonImpl;->tmpRectF1:Landroid/graphics/RectF;
...
.method private createAnimator(Lcom/google/android/material/animation/MotionSpec;FFF)Landroid/animation/AnimatorSet;
    ...
    invoke-direct {p0, p4, v0}, Lcom/google/android/material/floatingactionbutton/FloatingActionButtonImpl;->calculateImageMatrixFromScale(FLandroid/graphics/Matrix;)V

    .line 531
    iget-object v0, p0, Lcom/google/android/material/floatingactionbutton/FloatingActionButtonImpl;->view:Lcom/google/android/material/internal/VisibilityAwareImageButton;

    new-instance v1, Lcom/google/android/material/animation/ImageMatrixProperty;

    invoke-direct {v1}, Lcom/google/android/material/animation/ImageMatrixProperty;-><init>()V

    new-instance v2, Lcom/google/android/material/animation/MatrixEvaluator;

    invoke-direct {v2}, Lcom/google/android/material/animation/MatrixEvaluator;-><init>()V
    ...
    .line 538
    invoke-static {p1, v6}, Lcom/google/android/material/animation/AnimatorSetCompat;->playTogether(Landroid/animation/AnimatorSet;Ljava/util/List;)V
...
.method createBorderDrawable(ILandroid/content/res/ColorStateList;)Lcom/google/android/material/internal/CircularBorderDrawable;
    ...
    sget v1, Lcom/google/android/material/R$color;->design_fab_stroke_top_inner_color:I

    .line 586
    invoke-static {v4, v1}, Lo/ᕝ;->ˊ(Landroid/content/Context;I)I

    move-result v1

    sget v2, Lcom/google/android/material/R$color;->design_fab_stroke_end_inner_color:I

    .line 587
    invoke-static {v4, v2}, Lo/ᕝ;->ˊ(Landroid/content/Context;I)I

    move-result v2

    sget v3, Lcom/google/android/material/R$color;->design_fab_stroke_end_outer_color:I

    .line 588
    invoke-static {v4, v3}, Lo/ᕝ;->ˊ(Landroid/content/Context;I)I

    move-result v3

    .line 584
    invoke-virtual {v5, v0, v1, v2, v3}, Lcom/google/android/material/internal/CircularBorderDrawable;->setGradientColors(IIII)V

    .line 589
    int-to-float v0, p1

    invoke-virtual {v5, v0}, Lcom/google/android/material/internal/CircularBorderDrawable;->setBorderWidth(F)V

    .line 590
    invoke-virtual {v5, p2}, Lcom/google/android/material/internal/CircularBorderDrawable;->setBorderTint(Landroid/content/res/ColorStateList;)V
...
.method hide(Lcom/google/android/material/floatingactionbutton/FloatingActionButtonImpl$InternalVisibilityChangedListener;Z)V
    ...
    invoke-direct {p0, v0, v1, v2, v3}, Lcom/google/android/material/floatingactionbutton/FloatingActionButtonImpl;->createAnimator(Lcom/google/android/material/animation/MotionSpec;FFF)Landroid/animation/AnimatorSet;
...
.method setBackgroundDrawable(Landroid/content/res/ColorStateList;Landroid/graphics/PorterDuff$Mode;Landroid/content/res/ColorStateList;I)V
    ...
    .line 175
    iget-object v7, p0, Lcom/google/android/material/floatingactionbutton/FloatingActionButtonImpl;->shapeDrawable:Landroid/graphics/drawable/Drawable;
    ...
    invoke-interface {v0, v8}, Lo/ﻳ;->setTintList(Landroid/content/res/ColorStateList;)V
    ...
    .line 1164
    invoke-virtual {v7, v8}, Landroid/graphics/drawable/Drawable;->setTintMode(Landroid/graphics/PorterDuff$Mode;)V
    ...
    invoke-interface {v0, v8}, Lo/ﻳ;->setTintMode(Landroid/graphics/PorterDuff$Mode;)V
    ...
    .line 185
    invoke-static {p2}, Lo/＿;->ˋ(Landroid/graphics/drawable/Drawable;)Landroid/graphics/drawable/Drawable;
    ...
    .line 186
    iget-object v7, p0, Lcom/google/android/material/floatingactionbutton/FloatingActionButtonImpl;->rippleDrawable:Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {v0, v1}, Lcom/google/android/material/shadow/ShadowDrawableWrapper;->setAddPaddingForCorners(Z)V
...
.method setBackgroundTintList(Landroid/content/res/ColorStateList;)V
    ...
    .line 213
    iget-object v2, p0, Lcom/google/android/material/floatingactionbutton/FloatingActionButtonImpl;->shapeDrawable:Landroid/graphics/drawable/Drawable;
...
.method final setImageMatrixScale(F)V
    ...
    .line 285
    invoke-direct {p0, p1, v1}, Lcom/google/android/material/floatingactionbutton/FloatingActionButtonImpl;->calculateImageMatrixFromScale(FLandroid/graphics/Matrix;)V
...
.method final updatePadding()V
    ...
    .line 551
    iget-object v5, p0, Lcom/google/android/material/floatingactionbutton/FloatingActionButtonImpl;->tmpRect:Landroid/graphics/Rect;

    .line 552
    invoke-virtual {p0, v5}, Lcom/google/android/material/floatingactionbutton/FloatingActionButtonImpl;->getPadding(Landroid/graphics/Rect;)V

    .line 553
    invoke-virtual {p0, v5}, Lcom/google/android/material/floatingactionbutton/FloatingActionButtonImpl;->onPaddingUpdated(Landroid/graphics/Rect;)V
    ...
    invoke-interface {v0, v1, v2, v3, v4}, Lcom/google/android/material/shadow/ShadowViewDelegate;->setShadowPadding(IIII)V
