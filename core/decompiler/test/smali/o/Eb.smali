...
# static fields
.field private static final ˎ:Lo/EZ;
...
.method private final ˊ(Ljava/lang/String;)Lo/Ed;
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<NetworkExtrasT::Lo/\u153e$\u02cb;ServerParametersT:Lo/\u1526;>(Ljava/lang/String;)Lo/Ed;"
        }
    .end annotation
    ...
    iget-object v0, p0, Lo/Eb;->ॱ:Ljava/util/Map;

    invoke-interface {v3}, Lo/ᔂ;->getAdditionalParametersType()Ljava/lang/Class;
    ...
    check-cast v4, Lo/ᔾ$ˋ;

    new-instance v0, Lo/EE;

    invoke-direct {v0, v3, v4}, Lo/EE;-><init>(Lo/ᔂ;Lo/ᔾ$ˋ;)V
    :try_end_0
    ...
    invoke-direct {v0, v3}, Lo/EA;-><init>(Lo/Ⴡ;)V
    :try_end_1
    ...
    :catch_0
    invoke-direct {p0, p1}, Lo/Eb;->ˏ(Ljava/lang/String;)Lo/Ed;
...
.method private final ˏ(Ljava/lang/String;)Lo/Ed;
    .locals 4
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
    ...
    invoke-direct {v0, v2, v3}, Lo/EE;-><init>(Lo/ᔂ;Lo/ᔾ$ˋ;)V
    :try_end_3
...
# virtual methods
.method public final ˋ(Ljava/lang/String;)Lo/Ed;
    .locals 1
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
    ...
    invoke-direct {p0, p1}, Lo/Eb;->ˊ(Ljava/lang/String;)Lo/Ed;
...
.method public final ˎ(Ljava/lang/String;)Lo/ET;
    .locals 1
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
    ...
    invoke-static {p1}, Lo/EZ;->ˊ(Ljava/lang/String;)Lo/ET;
...
.method public final ˎ(Ljava/util/Map;)V
    ...
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(Ljava/util/Map<Ljava/lang/Class<+Ljava/lang/Object;>;Ljava/lang/Object;>;)V"
        }
    .end annotation

    iput-object p1, p0, Lo/Eb;->ॱ:Ljava/util/Map;
