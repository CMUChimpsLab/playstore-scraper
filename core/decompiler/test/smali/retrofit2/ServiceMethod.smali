...
.field private final callAdapter:Lretrofit2/CallAdapter;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lretrofit2/CallAdapter<TR;TT;>;"
        }
    .end annotation
.end field

.field private final callFactory:Lo/axM$ˋ;

.field private final contentType:Lo/ayh;

.field private final hasBody:Z

.field private final headers:Lo/ayd;
...
.field private final responseConverter:Lretrofit2/Converter;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lretrofit2/Converter<Lo/ayk;TR;>;"
        }
    .end annotation
.end field
...
.method constructor <init>(Lretrofit2/ServiceMethod$Builder;)V
    ...
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(Lretrofit2/ServiceMethod$Builder<TR;TT;>;)V"
        }
    .end annotation
    ...
    invoke-virtual {v0}, Lretrofit2/Retrofit;->callFactory()Lo/axM$ˋ;

    move-result-object v0

    iput-object v0, p0, Lretrofit2/ServiceMethod;->callFactory:Lo/axM$ˋ;
    ...
    invoke-virtual {v0}, Lretrofit2/Retrofit;->baseUrl()Lo/axZ;

    move-result-object v0

    iput-object v0, p0, Lretrofit2/ServiceMethod;->baseUrl:Lo/axZ;
    ...
    .line 87
    iget-object v0, p1, Lretrofit2/ServiceMethod$Builder;->headers:Lo/ayd;

    iput-object v0, p0, Lretrofit2/ServiceMethod;->headers:Lo/ayd;

    .line 88
    iget-object v0, p1, Lretrofit2/ServiceMethod$Builder;->contentType:Lo/ayh;

    iput-object v0, p0, Lretrofit2/ServiceMethod;->contentType:Lo/ayh;
...
# virtual methods
.method final adapt(Lretrofit2/Call;)Ljava/lang/Object;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(Lretrofit2/Call<TR;>;)TT;"
        }
    .end annotation
...
.method final varargs toCall([Ljava/lang/Object;)Lo/axM;
    .locals 13
    ...
    iget-object v2, p0, Lretrofit2/ServiceMethod;->baseUrl:Lo/axZ;

    iget-object v3, p0, Lretrofit2/ServiceMethod;->relativeUrl:Ljava/lang/String;

    iget-object v4, p0, Lretrofit2/ServiceMethod;->headers:Lo/ayd;

    iget-object v5, p0, Lretrofit2/ServiceMethod;->contentType:Lo/ayh;
    ...
    invoke-direct/range {v0 .. v8}, Lretrofit2/RequestBuilder;-><init>(Ljava/lang/String;Lo/axZ;Ljava/lang/String;Lo/ayd;Lo/ayh;ZZZ)V
    ...
    .line 113
    :cond_2
    iget-object v0, p0, Lretrofit2/ServiceMethod;->callFactory:Lo/axM$ˋ;

    invoke-virtual {v9}, Lretrofit2/RequestBuilder;->build()Lo/ayn;
...
.method final toResponse(Lo/ayk;)Ljava/lang/Object;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(Lo/ayk;)TR;"
