...
public class AppPrivacyRequesterService extends RequesterService {
	...
	public String inputFile = rootDir + "/privacyGradeRound2/all.input";
	private String propertiesFile = rootDir + "/app_review.properties";
	private String questionFile = rootDir + "/app_review.question";

	private String qulificationID="22V6DG67D1X3BGCZWGFK9JE1M9DG9R";//normal
	//private String qulificationID = "2ATCOK2JE1M750HOHVN6RZAC07RNUD";//sandbox
	...
	public static void main(String[] args)  {
			//String[] suffixList={"000", "001","002","003","004","005","006","007","008","009"};
			String[] suffixList={"010", "011","012","013"};
